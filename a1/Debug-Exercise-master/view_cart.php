...
<?php
	...
	//removed s because it is not refered to as aryProductsArray further in the code, it is referred to the one without the s
	...
	for ($x=0; $x < count($aryCartArray); $x++) {
		...
		//added semicolon so code can execute
