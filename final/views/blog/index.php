...
<?php include('views/elements/header.php');?>
    ...
    <div class="container">
        ...
        <?php foreach($posts as $p){?>
            ...
            <sub><?php echo 'Posted on ' . $p[date] . ' by <a href="'.BASE_URL.'members/users/'. $p[uid]. '">' . $p[first_name] . ' ' . $p[last_name] . '</a> in <a href="'.BASE_URL.'categories/'. $p[categoryid].'">' . $p[name] .'</a>' ?></sub>
